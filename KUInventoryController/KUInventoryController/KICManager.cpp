            ...
            if (yn.compare("y") == 0) {
                ...
                if (property < price) {
                    ...
                    if (p == 0) {
                        ...
                        this->sortprod[count-1] = new KICProduct(product[productnum]->getName(), numPro, product[productnum]->getSalesVolume(), product[productnum]->getFixedExpDate(), product[productnum]->getWPrice(), product[productnum]->getRPrice());
                    }
                        cout << "주문 완료했습니다" << endl;
